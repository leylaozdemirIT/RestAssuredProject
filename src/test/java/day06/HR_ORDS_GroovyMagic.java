...
public class HR_ORDS_GroovyMagic {
    ...
    public void testEmployees(){
        ...
        JsonPath jp = response.jsonPath(); // we can use groovy only in jsonPath

        // print all the id by getting a list
        System.out.println("All IDs " + jp.getList("items.employee_id") );

        // print first id and and last id
        ...
        // get all the last names from first 10-15
        ...
        String item105 = jp.getString("items.find { it.employee_id == 105 }.first_name");
        System.out.println(item105);

        // find the salary using above example with email value
