...
public class GetTestDataFromSpartanDatabase {
    ...
    public static void init() {
        ...
        RestAssured.baseURI = "http://3.81.143.40:8000";
        RestAssured.basePath = "/api";
        DB_Utility.createConnection("spartan1");
    }

    @DisplayName("Testing GET /Spartans/{id} by getting id from DB")
    @Test
    public void testDataFromDB() {
        ...
        // because body method is just getting int as int
